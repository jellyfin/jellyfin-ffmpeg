...
ffbuild_macbase() {
  ...
  cp "$BUILDER_ROOT"/images/base/git-mini-clone.sh /usr/local/bin/git-mini-clone
  chmod +x /usr/local/bin/git-mini-clone
  cp "$BUILDER_ROOT"/images/base/retry-tool.sh /usr/local/bin/retry-tool
  chmod +x /usr/local/bin/retry-tool
  cp "$BUILDER_ROOT"/images/base/check-wget.sh /usr/local/bin/check-wget
